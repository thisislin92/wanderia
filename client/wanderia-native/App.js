...
function MainStack() {
  return (
    <Stack.Navigator defaultScreenOptions={HomeScreen}>
      ...
      <Stack.Screen name='MapScreen' component={MapScreen} headerShown={false}/>
      <Stack.Screen name='EatsScreen' component={EatsScreen} headerShown={false}/>
      <Stack.Screen name='ChatScreen' component={ChatScreen} headerShown={true}/>
