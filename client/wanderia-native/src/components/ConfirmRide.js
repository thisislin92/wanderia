...
const ConfirmRide = () => {
    ...
    return (
      <SafeAreaView style={tw`bg-white flex-grow bg-white`}>
        <View style={tw`flex flex-row justify-evenly items-center bg-white my-auto`} >
          <TouchableOpacity className="bg-black w-36 py-3 px-4 rounded-full flex flex-row items-center justify-between" 
            onPress={() => {
